...
# Actual optimisation logic (after button click)
    if st.session_state.get("optimisation_started", False):
        ...
        # Placeholder for terminal-style log
            ...
            for name, group in grouped:
                ...
                try:
                    ...
                    if not results_inside.empty:
                        ...
                        log(f"No feasible solution for inside middle third optimization for {name}.")
                    ...
                    log(f"Error in inside middle third optimization for {name}: {e}")
                ...
                try:
                    ...
                    if not results_outside.empty:
                        ...
                        log(f"No feasible solution for outside middle third optimization for {name}.")
                    ...
                    log(f"Error in outside middle third optimization for {name}: {e}")
